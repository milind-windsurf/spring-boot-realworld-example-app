...
public class ArticleDatafetcher {
  ...
  private Article buildArticleResult(ArticleData articleData) {
    return Article.newBuilder()
        ...
        .createdAt(DateTimeFormatter.ISO_INSTANT.format(articleData.getCreatedAt().toInstant(java.time.ZoneOffset.UTC)))
        ...
        .updatedAt(DateTimeFormatter.ISO_INSTANT.format(articleData.getUpdatedAt().toInstant(java.time.ZoneOffset.UTC)))
        .build();
  }
}
